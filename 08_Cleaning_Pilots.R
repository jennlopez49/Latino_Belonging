...
pilot_clean <- pilot_op %>% mutate(
  ...
  HypAffectImm_Community = case_when(AffectImmComm == "It would negatively affect immigrants" ~ 1,
                                     AffectImmComm == "It would somewhat positively affect immigrants" ~ 2,
                                     AffectImmComm == "It would not affect immigrants" ~ 3,
                                     AffectImmComm == "It would somewhat positively affect immigrants" ~ 4,
                                     AffectImmComm == "It would positively affect immigrans" ~ 5),
