...
pilot_clean <- pilot_op %>% mutate(
  ...
  HypAffectLatino_Community = case_when(AffectLatinoComm == "It would negatively affect ${q://QID116/ChoiceGroup/SelectedChoices}s" ~ 1,
                                     ...
                                     AffectLatinoComm == "It would somewhat positively affect ${q://QID116/ChoiceGroup/SelectedChoices}s" ~ 4,
                                     AffectLatinoComm == "It would positively affect ${q://QID116/ChoiceGroup/SelectedChoices}s" ~ 5),
  HypAffectImm_Community = case_when(AffectLatinoComm == "It would negatively affect immigrants" ~ 1,
                                     AffectLatinoComm == "It would somewhat positively affect immigrants" ~ 2,
                                     AffectLatinoComm == "It would not affect immigrants" ~ 3,
                                     AffectLatinoComm == "It would somewhat positively affect immigrants" ~ 4,
                                     AffectLatinoComm == "It would positively affect immigrans" ~ 5),
  HypPersonallyAffect = case_when(PersonallyAffect == "No, the same amount" ~ 1, 
                                  PersonallyAffect == "No, a little less" ~ 2, 
